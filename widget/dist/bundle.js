	...
	function App() {
	  const onCommentClick = async () => {
	    ...
	    const txn = algosdk.makeApplicationNoOpTxnFromObject({
	      ...
	      appArgs: [new Uint8Array(Buffer.from('optin_asset'))],
	      suggestedParams: {
	        ...params
	      },
	      foreignAssets: [projectInfo.assetId]
	    });
	    ...
	    const txConfirmed = await algosdk.waitForConfirmation(algoClient, tx.txId, 4);
	    console.log(txConfirmed);
	  };
	  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("textarea", null), /*#__PURE__*/React.createElement("button", {
